...
public class RenderBatch implements Comparable<RenderBatch> {
    ...
    public boolean removeSpriteRenderer(@Nonnull SpriteRenderer spriteRenderer) {
        for(int i = 0; i < numSprites; i++) {
            if(sprites[i] == spriteRenderer) {
                // Remove this sprite from the array by shifting the rest of the array to the left
                System.arraycopy(sprites, i + 1, sprites, i, numSprites - 1 - i);
